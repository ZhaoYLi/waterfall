<template>
     <image-waterfall :imgList="imgList" :boxWidth="boxWidth" :lazyloadData="lazyloadData" :lineNums="lineNums"></image-waterfall>
</template>
<script>
import ImageWaterfall from '../components/HorizontalWaterfall.vue'
