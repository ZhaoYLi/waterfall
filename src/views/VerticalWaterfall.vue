<template>
     <image-waterfall :imgList="imgList" :direction="direction" :imgWidth="imgWidth" :imgHeight="imgHeight" :boxWidth="boxWidth"></image-waterfall>
</template>
<script>
import ImageWaterfall from '../components/VerticalWaterfall.vue'
